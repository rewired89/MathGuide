...
const STORAGE_KEY = 'mathguide_learned';
...
function buildConceptCard(concept, index) {
  ...
  card.innerHTML = `
    ...
    <div class="concept-card-body">
      ...
      ${concept.shortcut ? `
      <div class="detail-section">
        <div class="detail-label">The shortcut</div>
        <div class="shortcut-tip"><span class="shortcut-tip-icon">⚡</span>${concept.shortcut.replace(/\n/g, '<br>')}</div>
      </div>` : ''}
      ${concept.memory ? `
      <div class="detail-section">
      ...
      ${concept.examTip ? `
      <div class="detail-section">
        <div class="detail-label">Watch out for</div>
